...
Original file is located at
    https://colab.research.google.com/drive/10Nr_HWOEp7S_KKN93yMM1IXrosehyYbD
"""

# write a python program to simulate an ATM system where the user is prompted to enter their PIN.
# The User has a maximum of 3 attempts to input the correct PIN. if the correct PIN is entered,
# print"Access Granted" and stop further attempts using the break statement. if the PIN is incorrect.
# 3 times, print"Account Locked."
# Define the correct ATM PIN
